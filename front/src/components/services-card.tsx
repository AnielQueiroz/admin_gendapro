...
const ServicesCard = () => {
    ...
    const serviceSchema = Yup.object().shape({
        ...
        description: Yup.string().required("A descrição do serviço é obrigatória").min(10, "A descrição deve ter pelo menos 10 caracteres."),
        ...
        <div className="container mx-auto p-4">
            ...
            <Dialog open={openDialog} onOpenChange={setOpenDialog}>
                <DialogContent>
                    <DialogHeader>
                        <DialogTitle>
                            {selectedService ? `Editar serviço: ${selectedService.name}` : "Novo serviço"}
                        </DialogTitle>
                    </DialogHeader>
                    ...
                    <form className="space-y-4">
                        ...
                        <div>
                            <Label className="mt-4" htmlFor="descricaoServico">Descrição do serviço</Label>
                            <Input 
                                id="descricaoServico"
                                type="text" 
                        ...
                        <div>
                            <Label className="mt-4" htmlFor="precoServico">Preço do serviço</Label>
                            <Input
                                id="precoServico"
                                type="text" 
                        ...
                        <div>
                            <Label className="mt-4" htmlFor="imgServico">Image do serviço</Label>
                            <Input
                                id="imgServico"
                                type="text" 
